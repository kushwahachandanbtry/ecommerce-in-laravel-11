        ...
        <div class="row">
                        ...
                        <div class="swiper-container">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto"
                                        src="{{asset('uploads/products/thubmnails')}}/{{$product->image}}" width="104"
                                        height="104" alt="{{$product->name}}" />
                                </div>
                                @foreach (explode(",", $product->images) as $gthumb)
                                <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto"
                                        src="{{asset('uploads/products/thubmnails')}}/{{$gthumb}}" width="104" height="104" alt="" />
                                </div>
                                @endforeach
            ...
            <div class="col-lg-5">
                ...
                @if (Cart::instance('wishlist')->content()->where('id', $product->id)->count() > 0 )
                    <form action="{{route('wishlist.item.remove', ['rowId' => Cart::instance('wishlist')->content()->where('id', $product->id)->first()->rowId ])}}" id="frm-remove-item" method="POST">
                        @csrf 
                        @method('DELETE')
                                        
                        <a href="javascript:void(0)" onclick="document.getElementById('frm-remove-item').submit();" class="menu-link menu-link_us-s add-to-wishlist filled-heart"><svg width="16" height="16"
                                ...
                                @else
                                    <form name="addtocart-form" method="post" action="{{route('cart.add')}}">
                                        ...
                                        <button
                                            ...
                                            data-aside="cartDrawer" type="submit" title="Add To Cart">Add To Cart</button>
                                    </form>
                                @endif
                        </div>
