        ...
        <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data" action="{{route('admin.product.update')}}">
                        ...
                        <div class="select">
                            <select class="" name="category_id">
                                ...
                                @foreach ($categories as $category)
                                    <option {{$product->category_id == $product->category->id ? "selected" : ""}} value="{{$category->id}}">{{$category->name}}</option>                                
                                @endforeach
                            </select>
                        </div>
                    </fieldset>
                    ...
                    <fieldset class="brand">
                        ...
                        <div class="select">
                            <select class="" name="brand_id">
                                ...
                                <option {{$product->brand_id == $product->brand->id ? "selected" : ""}} value="{{$brand->id}}">{{$brand->name}}</option>
                                @endforeach
            ...
            <div class="wg-box">
                ...
                <div class="cols gap22">
                    ...
                    @error('quantity') <span class="alert alert-danger">{{$message}}</span> @enderror
                </div>
                    ...
                    <fieldset class="name">
                        ...
                        <div class="select mb-10">
                            <select class="" name="stock_status">
                                <option value="instock" {{$product->stock_status == '' ? 'instock' : ''}}>InStock</option>
                                <option value="outofstock" {{$product->stock_status == '' ? 'outofstock' : ''}}>Out of Stock</option>
                            </select>
                        </div>
                    </fieldset>
